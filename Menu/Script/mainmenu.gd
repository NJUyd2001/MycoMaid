...
var dia=preload("res://dialogue_sys/DiaSys/scenes/DiaUI.tscn")
var dia1="res://dialogue_sys/DiaSys/Dialogues/dia1.tres"
var dia2="res://dialogue_sys/DiaSys/Dialogues/dia2.tres"
...
func _on_start_game():
	print("逻辑：开始新游戏")
	# 示例：SceneTransition.change_scene("res://Menu/Scene/game_scene.tscn")
	SceneTransition.change_scene("res://Menu/Scene/game_selection.tscn")
...
func _on_quit_game_logic():
	print("逻辑：打开设置界面")
	SceneTransition.change_scene("res://Menu/Scene/settings_menu.tscn")

func _on_back_to_title_pressed():
	print("逻辑：返回上一级/标题画面 (quit按钮)")
	SceneTransition.change_scene("res://Menu/Scene/start_menu.tscn")
	
	
func _open_dialogue(dia_path:String):
	var diaScene=dia.instantiate()
	var dialogue_data=load(dia_path)
	diaScene.main_dialogue=dialogue_data
	get_tree().root.add_child(diaScene)
